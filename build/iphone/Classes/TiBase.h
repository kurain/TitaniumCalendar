...
// in simulator we redefine to format for TitaniumCalendar Developer console
...
{\
	NSString * exceptionName = [@"org.titaniumcalendar." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.titaniumcalendar";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UITitaniumCalendarNativeItemNone = -1, 
	UITitaniumCalendarNativeItemSpinner = -2,
	UITitaniumCalendarNativeItemProgressBar = -3,
	
	UITitaniumCalendarNativeItemSlider = -4,
	UITitaniumCalendarNativeItemSwitch = -5,
	UITitaniumCalendarNativeItemMultiButton = -6,
	UITitaniumCalendarNativeItemSegmented = -7,
	
	UITitaniumCalendarNativeItemTextView = -8,
	UITitaniumCalendarNativeItemTextField = -9,
	UITitaniumCalendarNativeItemSearchBar = -10,
	
	UITitaniumCalendarNativeItemPicker = -11,
	UITitaniumCalendarNativeItemDatePicker = -12,
	
	UITitaniumCalendarNativeItemInfoLight = -13,
	UITitaniumCalendarNativeItemInfoDark = -14,
	
	UITitaniumCalendarNativeItemDisclosure = -15,
	
	UITitaniumCalendarNativeItemContactAdd = -16
};
