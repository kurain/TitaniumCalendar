...
//@interface TitaniumCalendarObject : NSObject
//@end

@interface TitaniumCalendarObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TitaniumCalendarObject class]])
		{
			for (NSString *key in [[(TitaniumCalendarObject*)o modules] allKeys])
			{
